        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    join user on user.user_id = post.author order by post.post_id desc limit {$offset},{$limit} "; 
                    ...
                    ?> 
                        ...
                        if($pages>1){
                        echo "<li><a href='index.php?pages=".($pages - 1)."'>PREV</a></li>";    
                        }  
                        ...
                        echo "<li class='{$active}'><a href='index.php?pages=$i'>$i</a></li>";
                        }
                        if($pages != $total_pages){
                        echo "<li><a href='index.php?pages=".($pages + 1)."'>NEXT</a></li>";    
                        } 
                        } 
                        ?>
                        </ul>
