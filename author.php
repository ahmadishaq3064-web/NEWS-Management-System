      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                $query1 = "select * from post join user on post.author = user.user_id where user_id = {$author_id}";
                ...
                <h2 class="page-heading"><?php echo $row['username'];?></h2>
                   <?php 
                    ...
                    join user on user.user_id = post.author where post.author = {$author_id} order by post.post_id desc limit {$offset},{$limit} "; 
                    ...
                    ?> 
                        ...
                        if($pages>1){
                        echo "<li><a href='index.php?aid=".$author_id."&pages=".($pages - 1)."'>PREV</a></li>";    
                        }  
                        ...
                        echo "<li class='{$active}'><a href='index.php?aid=".$author_id."&pages=$i'>$i</a></li>";
                        }
                        if($pages != $total_pages){
                        echo "<li><a href='index.php?aid=".$author_id."&pages=".($pages + 1)."'>NEXT</a></li>";    
                        } 
                        } 
                        ?>
                        </ul>
