      ...
      <div class="container">
        <div class="row">
            ...
            <div class="post-container">
                    ...
                    $query1 = "select * from post where post.title like '%{$search_term}%'";
                   ...
                   <?php 
                    ...
                    join user on user.user_id = post.author where post.title like '%{$search_term}%' or post.description like '%{$search_term}%' order by post.post_id desc limit {$offset},{$limit} "; 
                    ...
                    ?> 
                        ...
                        if($pages>1){
                        echo "<li><a href='index.php?search=".$search_term."&pages=".($pages - 1)."'>PREV</a></li>";    
                        }  
                        ...
                        echo "<li class='{$active}'><a href='index.php?search=".$search_term."&pages=$i'>$i</a></li>";
                        }
                        if($pages != $total_pages){
                        echo "<li><a href='index.php?search=".$search_term."&pages=".($pages + 1)."'>NEXT</a></li>";    
                        } 
                        } 
                        else{
